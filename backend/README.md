...
## Project Structure
    ...
    ├── ideapros_llc_linkit_33508  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_linkit_33508`
...
2. Clone this repo and `cd ideapros_llc_linkit_33508`
